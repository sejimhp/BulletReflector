...
class Game:
    ...
    def update(self):
        if self.state == "MAIN":
            ...
            if self.enemy_manager.update(self.player, self.enemy_bullet_manager ,self.player_bullet_manager, self.effect_manager):
                self.score += 100
